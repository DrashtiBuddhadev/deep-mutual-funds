      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <div className="backdrop-blur-sm p-8 rounded-lg border border-white/10 shadow-lg" style={{background: 'linear-gradient(135deg, rgba(17, 80, 153, 0.15) 0%, rgba(17, 80, 153, 0.08) 30%, rgba(255, 255, 255, 0.08) 70%, rgba(255, 255, 255, 0.03) 100%)', boxShadow: '0 10px 25px -5px rgba(0, 0, 0, 0.15)'}}>
              <div className="font-medium mb-2 text-sm uppercase tracking-wide" style={{color: '#e3b317'}}>
                Investment & Financial Planning
              </div>
              <h1 className="font-heading font-bold text-2xl md:text-3xl lg:text-4xl text-white mb-4 leading-tight">
                {title}
              </h1>
              ...
              {showCTA && (
                <Button className="text-white px-8 py-3 text-lg font-medium rounded-md transition-all duration-300" style={{backgroundColor: '#e3b317', boxShadow: '0 10px 25px rgba(227, 179, 23, 0.25)'}} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#d4a516'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#e3b317'}>
          ...
          {/* Right Side - Circular Service Icons */}
