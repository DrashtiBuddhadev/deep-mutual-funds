      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-8">
            <div className="mb-4">
              <span className="inline-block px-3 py-1 rounded-full text-sm font-medium" style={{backgroundColor: 'rgba(17, 80, 153, 0.1)', color: '#115099'}}>
                About Us
              </span>
            </div>
            
            <h2 className="font-heading font-medium text-2xl lg:text-3xl mb-6 leading-tight" style={{color: '#115099'}}>
              ...
              {metrics.map((metric, index) => {
                ...
                return (
                  <div key={index} className="flex items-center space-x-4">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{backgroundColor: '#e3b317'}}>
                      <IconComponent className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <div className="font-bold text-xl" style={{color: '#115099'}}>{metric.value}</div>
            ...
            <div className="flex items-center space-x-6">
              <button className="text-white px-6 py-3 rounded-lg font-medium transition-colors hover:opacity-90" style={{backgroundColor: '#e3b317'}}>
                Learn more →
              </button>
              
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{backgroundColor: 'rgba(17, 80, 153, 0.1)'}}>
                  <svg className="w-6 h-6" style={{color: '#115099'}} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <div>
                  <div className="text-sm text-gray-500">Call Us Now</div>
                  <div className="font-semibold" style={{color: '#115099'}}>+91-123-456-7890</div>
                </div>
              </div>
            </div>
          </div>
